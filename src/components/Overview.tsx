            ...
            <div className="">
                ...
                className="relative max-w-4xl mx-auto shadow-xl">
                    ...
                    <Dialog>
                        ...
                        <Button variant="secondary" size="icon" className="cursor-pointer absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-150">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 gap-5 mt-8 md:mt-16 xl:grid-cols-[3fr,2.5fr] xl:items-center">
                    ...
                    whileInView='end'
                    viewport={{ once:true }}
                    className="section-title text-center lg:max-w-[30ch] lg:mx-auto xl:text-center">
