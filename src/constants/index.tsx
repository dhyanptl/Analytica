...
export const navMenu: MenuItem[] = [
  {
    ...
    submenu: [
      ...
      },
      {
        ...
        label: 'Analytica Elements',
        desc: 'Unstyled UI primitives for endless customization. Powered by Analytica',
      },
      {
        href: '#',
        icon: <BrainCircuit />,
...
export const heroData = {
  ...
  sectionTitle: 'Know what’s coming before it',
  decoTitle: 'Matters',
  sectionText:
...
export const reviewData = {
  ...
  reviewCard: [
    {
      title: 'We’re building a better application now, thanks to Analytica.',
    ...
    {
      title: 'Great Service from a expert support system of Analytica',
      text: 'Experience exceptional service and support from Analytica expert team, dedicated to providing knowledgeable assistance and ensuring a seamless',
...
export const blogData = {
  ...
  blogs: [
    ...
    },
    {
      imgSrc: blog3,
      badge: 'Growth',
      title: 'How to Build the Ultimate Tech Stack to Accelerate Business Growth',
      author: {
        avatarSrc: avatar3,
